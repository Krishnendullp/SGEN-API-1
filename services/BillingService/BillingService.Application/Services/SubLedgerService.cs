...
public class SubLedgerService : CrudService<SubLedger, SubLedgerDto, long>, ISubLedgerService
{
    private readonly SGenDbContext _context;
    private readonly IIdentityServices _identityService;
    private readonly IMapper _mapper;
    public SubLedgerService(IQueryRepository<SubLedger, long> repository,
        IMapper mapper, SGenDbContext context, IIdentityServices identityService,
    ICommandRepository<SubLedger, long> commandRepo)
