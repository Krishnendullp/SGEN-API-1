...
{
    public class LedgerMasterService : CrudService<LedgerMaster, LedgerMasterDto, long>, ILedgerMasterService
    {
        private readonly SGenDbContext _context;
        private readonly IIdentityServices _identityService;
        private readonly IMapper _mapper;
        public LedgerMasterService(IQueryRepository<LedgerMaster, long> repository,
            IMapper mapper, SGenDbContext context, IIdentityServices identityService,
        ICommandRepository<LedgerMaster, long> commandRepo)
